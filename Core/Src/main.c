...
typedef enum {CK_77, CK_0D, CK_00, CK_84, READ_X1, READ_X2, READ_X3, READ_Y1, READ_Y2, READ_Y3, READ_Z1, READ_Z2, READ_Z3, CHECKSUM}STATE;
typedef enum {READY,CHECK,DONE}STATE_BTN;
STATE state = CK_77;
